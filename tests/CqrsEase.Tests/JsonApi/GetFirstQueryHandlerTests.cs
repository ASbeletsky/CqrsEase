namespace CqrsEase.Tests.JsonApi
{
    ...
    public class GetFirstQueryHandlerTests
    {
        ...
        public void AppliesSpecification_WhenProvided()
        {
            ...
            var query = new GetFirstQuery<BlogDto>(spec);
        ...
        {
            var query = new GetFirstQuery<BlogDto>(new FetchOnlyStrategy<BlogDto>(b => b.Id, b => b.Title));
        ...
        {
            var query = new GetFirstQuery<BlogDto>(new FetchOnlyStrategy<BlogDto>(b => b.Id, b => b.Author));
